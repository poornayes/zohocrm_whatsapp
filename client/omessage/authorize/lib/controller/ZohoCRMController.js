...
var ZohoCRM = {
    ...
    checkIsAlreadyInstalled: function (rightServiceName, leftId, rightId) {
        return new Promise((resolve, reject) => {
            ...
            ZohoCRM.get(apiVariableName + "integId").then(function (integId) {
                if (integId != undefined && integId != "" && integId != "null") {
                    ZohoCRM.get(apiVariableName + "hash").then(function (hash) {
    ...
    // getAssociatedIntegId: function (thisObj) {
    ...
    //getAssociatedHash: function (thisObj) {
...
function getInstallationDetails(leftId, rightId) {
    var rightServiceName = urlParams.get("rightServiceName");
    return new Promise((resolve, reject) => {
            ...
            $.ajax({
                ...
                success: function (response, textStatus, jqXHR) {
                    ...
                    if (response.integId != null && response.hash != null) {
                        ...
                        ZohoCRM.save(hashValueMap);
                        ZohoCRM.save(integIdValueMap);
