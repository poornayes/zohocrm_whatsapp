    ...
    sendNotification(notifyObj, recipient) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyObject(notifyObj, 'notification_object', true);
                validator_1.isNonEmptyArray(recipient, 'recipient', true);
                validator_1.ObjectHasProperties(
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                notifyObj, ['message'], 'notification_object', true);
