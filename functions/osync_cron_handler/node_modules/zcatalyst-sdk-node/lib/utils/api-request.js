...
const { PROJECT_KEY_NAME, IS_LOCAL, ENVIRONMENT_KEY_NAME, USER_KEY_NAME, CREDENTIAL_USER, CATALYST_ORIGIN, PRODUCT_NAME, API_VERSION, USER_AGENT } = constants_1.default;
...
function sendRequest(config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        headers[USER_AGENT] = 'zcatalyst-nodejs-sdk/' + package_json_1.version;
        if (config.data !== undefined) {
            switch (config.type) {
                ...
                case 'file':
                    ...
                    break;
                default:
                    data = querystring_1.stringify(config.data);
        ...
        const parsed = url_1.parse(config.url);
...
class HttpClient {
    ...
    send(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const resp = yield sendRequest(req);
...
class AuthorizedHttpClient extends HttpClient {
    ...
    send(request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return _super.send.call(this, requestCopy);
        });
    }
}
