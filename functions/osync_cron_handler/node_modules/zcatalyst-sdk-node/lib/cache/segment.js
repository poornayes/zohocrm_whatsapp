...
const { REQ_METHOD } = constants_1.default;
class Segment {
    constructor(cacheInstance, segmentDetails) {
        this.requester = cacheInstance.requester;
        const segmentId = parseInt(segmentDetails.id + '');
        this.id = isNaN(segmentId) ? null : segmentId;
        this.segmentName = validator_1.isNonEmptyString(segmentDetails.segment_name)
    ...
    put(key, value, expiry) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyString(key, 'cache_key', true);
    ...
    update(key, value, expiry) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyString(value, 'cache_value', true);
                validator_1.isNonEmptyString(key, 'cache_key', true);
            }, error_1.CatalystCacheError);
            const apiUrl = this.id === null ? '/cache' : `/segment/${this.id}/cache`;
            const postData = {
    ...
    get(cacheKey) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyString(cacheKey, 'cache_key', true);
            }, error_1.CatalystCacheError);
            const apiUrl = this.id === null ? '/cache' : `/segment/${this.id}/cache`;
            const query = {
                cacheKey
