...
class Folder {
    ...
    update(folderDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonNullObject(folderDetails, 'folder_object', true);
                validator_1.isNonEmptyString(folderDetails.folder_name, 'folder_name in folder_object', true);
    ...
    getFileDetails(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyStringOrNumber(id, 'file_id', true);
            }, error_1.CatalystFilestoreError);
            const request = {
    ...
    uploadFile(fileDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonNullObject(fileDetails, 'file_object', true);
                validator_1.isNonEmptyString(fileDetails.name, 'name in file_object', true);
            }, error_1.CatalystFilestoreError);
