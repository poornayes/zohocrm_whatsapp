...
class Filestore {
    ...
    createFolder(name) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyString(name, 'folder_name', true);
    ...
    getFolderDetails(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyStringOrNumber(id, 'folder_id', true);
            }, error_1.CatalystFilestoreError);
            const request = {
                method: REQ_METHOD.get,
                path: `/folder/${id}`,
    ...
    folder(id) {
        ...
        return new folder_1.Folder(this, { id: parseInt(id + '') });
    }
}
