...
class Datastore {
    ...
    getTableDetails(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyStringOrNumber(id, 'table_id', true);
    ...
    table(id) {
        if (!validator_1.isNonEmptyStringOrNumber(id)) {
        ...
        if (validator_1.isNumber(Number(id))) {
            return new table_1.Table(this, { table_id: parseInt(id + '') });
        }
        else {
